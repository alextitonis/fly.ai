...
const DOC_TITLES: Record<string, string> = {
  explainers: "Technical explainers",
  "treasury-status": "Treasury status",
};
  ...
  if (error) {
    return (
      <div className="container mx-auto max-w-4xl px-6 py-20 text-center">
        ...
        <p className="text-secondary-t">Could not load the requested document. Please try again later.</p>
      </div>
    );
  }
