...
|---------------|-----------|---------|-------|
| SHIT Protocol v2 (primary base) | `https://github.com/SHIT Protocol/shit-frontend-v2` | MIT | App shell, layout, design system, staking/governance/treasury modules |
...
| SHIT Protocol V3 | `https://github.com/SHIT Protocol/shit-v3` | Kernel, treasury, policies |
