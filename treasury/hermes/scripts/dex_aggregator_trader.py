...
class DexAggregatorTrader:
            ...
            if solana_pk:
                try:
                    ...
                    self.solana_rpc = os.environ.get(
                        "SOLANA_RPC_URL",
                        f"https://mainnet.helius-rpc.com/?api-key={os.environ.get('HELIUS_API_KEY', 'YOUR_HELIUS_API_KEY')}",
                    )
    ...
    def get_web3(self) -> Web3 | None:
        """Get Web3 connection."""
        rpcs = [
            f"https://base-mainnet.g.alchemy.com/v2/{os.environ.get('ALCHEMY_API_KEY', 'YOUR_ALCHEMY_KEY')}",
            "https://base.llamarpc.com",
            "https://base.drpc.org",
            "https://mainnet.base.org",
            f"https://bold-proportionate-dinghy.base-mainnet.quiknode.pro/{os.environ.get('QUICKNODE_KEY', 'YOUR_QUICKNODE_KEY')}",
        ]
        for rpc in rpcs:
            try:
