import{dV as k,dU as le,cU as c,cW as pe,cG as v,cH as V,cK as f,cL as g,cM as d,cJ as l,dh as $,d3 as H,di as u,cI as me,c$ as w,cO as B,df as U,em as fe,d$ as F,cY as K,dO as A,d7 as M,cR as we,cV as E,dX as z,ej as oe,dg as be,cQ as ce,eq as ge,er as ye}from"./index-V0rtL5dI.js";import{P as D}from"./index-CwyyTAbN.js";import{S as ve}from"./SwapController-BekL2G-K.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
