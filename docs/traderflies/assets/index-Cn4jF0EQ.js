import{cG as U,cH as Ie,cI as ve,cJ as b,cK as _,cL as C,dh as f,cM as l,cX as I,es as Se,cW as v,et as ke,eu as y,d1 as O,ev as _e,ew as N,dO as ce,cS as A,ex as me,c$ as m,df as T,cY as M,cV as R,d4 as Ce,dV as G,d8 as $e,d9 as Re,da as Oe,d7 as P,cU as z,di as h,cO as Ue,cQ as Le,ey as Ne,cR as qe,en as ge}from"./index-CJTqPxSt.js";const De=U`
  :host {
    position: relative;
  }
...
`;var j=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};const ct=3,ut=2,lt=.3,dt="200px",pt={"accent-primary":Ue.tokens.core.backgroundAccentPrimary};let D=class extends C{constructor(){super(...arguments),this.rings=ct,this.duration=ut,this.opacity=lt,this.size=dt,this.variant="accent-primary"}render(){const e=pt[this.variant];this.style.cssText=`
    ...
    `}renderRing(e,n){const i=`animation-delay: ${e/n*this.duration}s;`;return l`<div class="pulse-ring" style=${i}></div>`}};D.styles=[Ie,ot];j([b({type:Number})],D.prototype,"rings",void 0);j([b({type:Number})],D.prototype,"duration",void 0);j([b({type:Number})],D.prototype,"opacity",void 0);j([b()],D.prototype,"size",void 0);j([b()],D.prototype,"variant",void 0);D=j([_("wui-pulse")],D);const Ae=[{id:"received",title:"Receiving funds",icon:"dollar"},{id:"processing",title:"Swapping asset",icon:"recycleHorizontal"},{id:"sending",title:"Sending asset to the recipient address",icon:"send"}],Ee=["success","submitted","failure","timeout","refund"],ht=U`
  :host {
    display: block;
    height: 100%;
    width: 100%;
